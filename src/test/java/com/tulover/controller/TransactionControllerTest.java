...
public class TransactionControllerTest {
    ...
    public void shouldGetTransaction() {
        ...
        final TransactionDTO transactionDTOReturned = transactionController.getTransaction(transactionId);
        ...
        Assert.assertEquals(transactionDTOReturned, transactionDTO);
    }
